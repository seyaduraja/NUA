      ...
      <div className="flex flex-col p-3 md:p-10 gap-10">
        ...
        <div className="w-full flex flex-col justify-center items-center">
          <div className="w-full md:w-[60%] flex flex-col gap-5 ">
            <div className="w-full max-h-[600px] overflow-y-auto flex flex-col gap-5 shadow-md p-5 rounded-md shadow-gray-300">
              {cart.length === 0 ?
                  ...
                  {cart.map((c) => (
                    <div key={c.id} className="w-full flex justify-around items-center border-2 rounded-md border-purple-600 p-4  ">
                      ...
                      <div className="w-1/2 flex flex-col gap-7 ">
                        <p className="font-semibold text-base md:text-2xl">{c.title}</p>
                        <div>
                        ...
                        <div className="font-semibold text-lg flex justify-between items-center">
                          Sub Total : <span className="text-purple-700 text-base md:text-3xl">₹{(c.price * c.qty).toFixed(2)}</span>
                        </div>
            ...
            <div className="flex justify-between items-center px-10 md:px-20 text-xl md:text-3xl font-semibold ">Total Price : <span className="text-purple-700 ">
              <div className="bg-black h-10 w-[100px] rounded-md relative">
                <button className="text-2xl text-white bg-purple-500 rounded-md h-10 w-[100px] font-semibold absolute bottom-1 right-1 ">
